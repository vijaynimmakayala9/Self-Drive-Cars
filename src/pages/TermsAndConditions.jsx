    ...
    <div className="d-flex flex-column min-vh-100 bg-white">
      ...
      <div className="flex-grow-1 container my-5">
        ...
        <div className="text-dark" style={{ lineHeight: "1.6" }}>
          <p>
            These Terms and Conditions ("Terms") govern your use of the Self Drive Cars application ("App"). By accessing or using the App, you agree to comply with and be bound by these Terms.
          </p>
          ...
          <p>
            Self Drive Cars is not liable for any indirect, incidental, or consequential damages arising from your use of the App.
          </p>
