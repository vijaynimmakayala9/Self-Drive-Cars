    ...
    <div className="d-flex flex-column min-vh-100 bg-white">
      <div className="container my-5 flex-grow-1">
        ...
        <div className="text-dark" style={{ lineHeight: "1.6" }}>
          <p>
            At <strong>Self Drive Cars</strong>, we respect your privacy and are committed to protecting your personal data. This Privacy Policy explains how we collect, use, and protect your data when you use our App.
          </p>
